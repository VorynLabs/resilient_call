...
Gem::Specification.new do |spec|
  ...
  spec.email = ["wesleysenan@gmail.com"]

  spec.summary = "Resilient call wrappers (retries, timeouts, circuit breaking) for Ruby."
  spec.description = "ResilientCall provides helpers to wrap calls with retry, timeout and circuit-breaker behavior."
